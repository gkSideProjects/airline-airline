...
export function filterEasyjet(data, days, countries, airports) {
    let result = filterEasyjetFlights(data, days);
    result = filterEasyjetByCountry(result, countries);
    result = filterEasyjetByAirport(result, airports);
    result = getEasyjetLocationData(result);
